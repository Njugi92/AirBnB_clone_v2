...
class TestPlaceDocs(unittest.TestCase):
    """This tests checks documentation and style of Place class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_place(self):
        """It tests that models/place.py conforms to PEP8."""
    ...
    def test_place_class_docstring(self):
        """This tests for Place class docstring"""
        self.assertIsNot(Place.__doc__, None,
    ...
    def test_place_func_docstrings(self):
        """It tests for presence of docstrings in Place methods"""
...
class TestPlace(unittest.TestCase):
    ...
    def test_city_id_attr(self):
        """This tests Place has attr city_id, and it's empty str"""
        place = Place()
    ...
    def test_user_id_attr(self):
        """test Place has attr user_id, and it's empty str"""
        place = Place()
    ...
    def test_description_attr(self):
        """It tests Place has attr description, and it's empty string"""
        place = Place()
    ...
    def test_number_bathrooms_attr(self):
        """test Place has attr number_bathrooms, and it's int == 0"""
        place = Place()
    ...
    def test_max_guest_attr(self):
        """To test Place has attr max_guest, and it's an int == 0"""
        place = Place()
    ...
    def test_longitude_attr(self):
        """It tests Place has attr longitude, and it's float == 0.0"""
        place = Place()
    ...
    def test_to_dict_creates_dict(self):
        """The test to_dict method creates dictionary with proper attrs"""
        p = Place()
        new_d = p.to_dict()
    ...
    def test_to_dict_values(self):
        """It tests values in dict returned from to_dict are correct"""
    ...
    def test_str(self):
        """It tests that str method has the correct output"""
        place = Place()
