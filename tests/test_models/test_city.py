#!/usr/bin/python3
"""
Enables the TestCityDocs classes
"""
...
class TestCityDocs(unittest.TestCase):
    """It tests to check documentation and style of City class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_city_module_docstring(self):
        """This tests the city.py module docstring"""
    ...
    def test_city_func_docstrings(self):
        """Tests for presence of docstrings in City methods"""
...
class TestCity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """This tests City has attribute name, and it's an empty string"""
        city = City()
    ...
    def test_state_id_attr(self):
        """Tests City has attribute state_id, and it's an empty string"""
        city = City()
    ...
    def test_str(self):
        """This test that str method has the correct output"""
        city = City()
