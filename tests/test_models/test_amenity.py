#!/usr/bin/python3
"""
It contains the TestAmenityDocs classes
"""
...
class TestAmenityDocs(unittest.TestCase):
    ...
    def test_amenity_module_docstring(self):
        """It tests the amenity.py module docstring"""
...
class TestAmenity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Tests Amenity has attribute name, and it's as an empty string"""
        amenity = Amenity()
    ...
    def test_to_dict_values(self):
        """The test values dict returned from to_dict are correct"""
    ...
    def test_str(self):
        """It tests that the str method has correct output"""
        amenity = Amenity()
