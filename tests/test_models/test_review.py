#!/usr/bin/python3
"""
It contains the TestReviewDocs classes
"""
...
class TestReviewDocs(unittest.TestCase):
    """The tests to check documentation and style of Review class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_review_module_docstring(self):
        """This tests for review.py module docstring"""
    ...
    def test_review_func_docstrings(self):
        """This tests the presence of docstrings in Review methods"""
...
class TestReview(unittest.TestCase):
    """Module tests the Review class"""
    def test_is_subclass(self):
        """It tests if Review is a subclass of BaseModel"""
        review = Review()
    ...
    def test_place_id_attr(self):
        """It tests Review has attr place_id, and it's empty str"""
        review = Review()
    ...
    def test_user_id_attr(self):
        """Tests Review has attr user_id, and it's empty str"""
        review = Review()
    ...
    def test_text_attr(self):
        """This tests Review has attr text, and it's empty string"""
        review = Review()
    ...
    def test_str(self):
        """This tests the str method has correct output"""
        review = Review()
