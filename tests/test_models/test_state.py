#!/usr/bin/python3
"""
This contains the TestStateDocs classes
"""
...
class TestStateDocs(unittest.TestCase):
    """The tests to check documentation and style of State class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_state(self):
        """This tests that models/state.py conforms to PEP8."""
...
class TestState(unittest.TestCase):
    ...
    def test_is_subclass(self):
        """This tests that State is a subclass of BaseModel"""
        state = State()
    ...
    def test_to_dict_creates_dict(self):
        """tests to_dict method creates dictionary with proper attrs"""
        s = State()
        new_d = s.to_dict()
    ...
    def test_to_dict_values(self):
        """To test values in dict returned from to_dict are correct"""
    ...
    def test_str(self):
        """It tests that str method has correct output"""
        state = State()
